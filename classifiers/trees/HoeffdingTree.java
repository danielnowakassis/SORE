...
import moa.classifiers.trees.EFDT.ActiveLearningNode;
import moa.classifiers.trees.EFDT.LearningNode;
import moa.classifiers.trees.EFDT.LearningNodeNB;
import moa.classifiers.trees.EFDT.LearningNodeNBAdaptive;
...
public class HoeffdingTree extends AbstractClassifier implements MultiClassClassifier,
    ...
    public double splitConfidence;

    public double tieThreshold;

    public String splitCriterion;

    public String leafPrediction;
...
//                if (obs instanceof ARTEAttributeClassObserver){
//                    if( ((ARTEAttributeClassObserver) obs).getRand() == null ){
//                        ((ARTEAttributeClassObserver) obs).setRand(ht.classifierRandom);
//                    }
//                }
...
//                    }
    ...
    public void resetLearningImpl() {
        ...
        this.splitConfidence= this.splitConfidenceOption.getValue();

        this.tieThreshold = this.tieThresholdOption.getValue();

        this.splitCriterion = this.splitCriterionOption.getDefaultCLIString();

        this.leafPrediction = this.leafpredictionOption.getDefaultCLIString();
    }
    ...
    public void trainOnInstanceImpl(Instance inst) {
        ...
        if (leafNode instanceof LearningNode) {
            ...
            if (this.growthAllowed
                ...
                if (weightSeen
                        - activeLearningNode.getWeightSeenAtLastSplitEvaluation() >= this.gracePeriod) {
    ...
    protected void attemptToSplit(ActiveLearningNode node, SplitNode parent,
        ...
        if (!node.observedClassDistributionIsPure()) {
            SplitCriterion splitCriterion = null;
            try {
                splitCriterion = (SplitCriterion) ClassOption.cliStringToObject(this.splitCriterion, SplitCriterion.class, null);
            } catch (Exception e) {
    ...
    protected LearningNode newLearningNode(double[] initialClassObservations) {
        ...
        switch (this.leafPrediction){
            ...
            case "NBAdaptive":
                ...
                break;
            default:
                throw new IllegalStateException("Unexpected value: " + this.leafPrediction);
        }
        return ret;
    }
